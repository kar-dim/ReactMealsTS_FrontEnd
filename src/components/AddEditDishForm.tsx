                ...
                <form id={adminStyle.add_dish_form} onSubmit={(event) => addOrEditDish(event)}>
                    <div id={adminStyle.add_dish_1}>
                        <div id={adminStyle.add_dish_1_name}>
                            <label id={adminStyle.adminmenu_dish_name_label} htmlFor={adminStyle.adminmenu_dish_name}>Dish name:</label><span>{spacing}</span>
                        ...
                        <div id={adminStyle.add_dish_1_description}>
                            <label id={adminStyle.adminmenu_dish_description_label} htmlFor={adminStyle.adminmenu_dish_description}>Dish Description:</label><span>{spacing}</span>
                        ...
                        <div id={adminStyle.add_dish_1_price}>
                            <label id={adminStyle.adminmenu_dish_price_label} htmlFor={adminStyle.adminmenu_dish_price}>Dish Price:</label><span>{spacing}</span>
