    ...
    <>
        ...
        <div id={AboutStyles.about_main}>
            <div id={AboutStyles.about_main_content}>
                ...
                <p>Word of Dimitris's culinary prowess spread like wildfire. Food critics and diners alike were enchanted by the symphony of flavors that danced on their palates. Each dish was a narrative of his journey, an homage to his admiration for Japanese culture, and a testament to his determination to carve his own path.</p>
                <p>"Jimmy's Foodzilla" became more than a restaurant – it became a destination for those seeking not just a meal, but an experience. Dimitris's dedication to his craft and his respect for Japanese culture shone through in every aspect, from the carefully selected ingredients to the personalized service.</p>
                <p>As the years passed, "Jimmy's Foodzilla" continued to flourish. Dimitris's journey had not been without challenges, but his passion and dedication had paved the way for success. His story inspired aspiring chefs and dreamers to pursue their own visions with the same fervor.</p>
                <p>And so, Dimitris's tale became a legend in the culinary world, a story of a man who followed his heart and turned his love for Japanese culture into a gastronomic haven that touched the lives and taste buds of many.</p><br></br>
                <p style={{fontStyle : "italic"}}>Thanks ChatGPT for this story :)</p>
            </div>
        </div>
    </>
    );
